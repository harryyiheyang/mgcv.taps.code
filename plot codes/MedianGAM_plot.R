Gaussian_Interaction <- readRDS(file.path("outputs", "simulation", "Gaussian_Interaction_Median.rds"))
Gaussian_Linearity = readRDS(file.path("outputs", "simulation", "Gaussian_Linearity_Median.rds"))
Gaussian_Breakpoint = readRDS(file.path("outputs", "simulation", "Gaussian_Breakpoint_Median.rds"))
Gaussian_Changepoint = readRDS(file.path("outputs", "simulation", "Gaussian_Changepoint_Median.rds"))
