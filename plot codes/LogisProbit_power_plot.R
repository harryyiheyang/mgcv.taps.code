Logistics_Interaction <- readRDS(file.path("outputs", "simulation", "Binary_Interaction.rds"))
Logistics_Breakpoint <- readRDS(file.path("outputs", "simulation", "Binary_Breakpoint.rds"))
Logistics_Linearity <- readRDS(file.path("outputs", "simulation", "Binary_Linearity.rds"))
Logistics_Changepoint <- readRDS(file.path("outputs", "simulation", "Binary_Changepoint.rds"))

Probit_Interaction <- readRDS(file.path("outputs", "simulation", "Binary_Interaction_Probit.rds"))
Probit_Breakpoint <- readRDS(file.path("outputs", "simulation", "Binary_Breakpoint_Probit.rds"))
Probit_Linearity <- readRDS(file.path("outputs", "simulation", "Binary_Linearity_Probit.rds"))
Probit_Changepoint <- readRDS(file.path("outputs", "simulation", "Binary_Changepoint_Probit.rds"))
