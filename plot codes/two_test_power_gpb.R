Binary_Breakpoint <- readRDS(file.path("outputs", "simulation", "Binary_Breakpoint.rds"))
Binary_Interaction <- readRDS(file.path("outputs", "simulation", "Binary_Interaction.rds"))
Poisson_Breakpoint <- readRDS(file.path("outputs", "simulation", "Poisson_Breakpoint.rds"))
Poisson_Interaction <- readRDS(file.path("outputs", "simulation", "Poisson_Interaction.rds"))
Binary_Changepoint <- readRDS(file.path("outputs", "simulation", "Binary_Changepoint.rds"))
Binary_Linearity <- readRDS(file.path("outputs", "simulation", "Binary_Linearity.rds"))
Poisson_Linearity <- readRDS(file.path("outputs", "simulation", "Poisson_Linearity.rds"))
Poisson_Changepoint <- readRDS(file.path("outputs", "simulation", "Poisson_Changepoint.rds"))
Gaussian_Interaction <- readRDS(file.path("outputs", "simulation", "Gaussian_Interaction.rds"))
Gaussian_Linearity <- readRDS(file.path("outputs", "simulation", "Gaussian_Linearity.rds"))
Gaussian_Changepoint <- readRDS(file.path("outputs", "simulation", "Gaussian_Changepoint.rds"))
Gaussian_Breakpoint <- readRDS(file.path("outputs", "simulation", "Gaussian_Breakpoint.rds"))
