...
filename <- file.path(out_dir, "Gaussian_Changepoint.rds")
for(i in 1:5){
for(j in 1:10){
...
fit=gam(y~s(x1,by=z1,bs="AMatern",k=10,m=100,xt=list(getA=piecewise_linearity,para=0.5))+s(x2,by=z2,bs="cr",k=10)+
