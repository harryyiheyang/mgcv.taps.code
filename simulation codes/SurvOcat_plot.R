Ordinal_Interaction <- readRDS(file.path("outputs", "simulation", "Ordinal_Interaction.rds"))
Ordinal_Breakpoint <- readRDS(file.path("outputs", "simulation", "Ordinal_Breakpoint.rds"))
Ordinal_Linearity <- readRDS(file.path("outputs", "simulation", "Ordinal_Linearity.rds"))
Ordinal_Changepoint <- readRDS(file.path("outputs", "simulation", "Ordinal_Changepoint.rds"))

Surv_Interaction <- readRDS(file.path("outputs", "simulation", "Surv_Interaction.rds"))
Surv_Breakpoint <- readRDS(file.path("outputs", "simulation", "Surv_Breakpoint.rds"))
Surv_Linearity <- readRDS(file.path("outputs", "simulation", "Surv_Linearity.rds"))
Surv_Changepoint <- readRDS(file.path("outputs", "simulation", "Surv_Changepoint.rds"))
