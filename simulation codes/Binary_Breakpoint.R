...
f4=0*x4
eta=f1+f2+f3
y=rbinom(n,1,exp(eta-5)/(1+exp(eta-5)))
fit=bam(y~s(x1,bs="AMatern",k=10,m=100,xt=list(getA=linearity_discontinuity,para=0.5))+s(x2,bs="cr",k=10)+s(x3,bs="cr",k=15)+s(x4,bs="cr",k=10),method="REML",family=binomial())
